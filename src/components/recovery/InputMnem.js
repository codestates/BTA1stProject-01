...
const InputMnem = () => {
  ...
  return (
    <Container>
      <Warning>지갑 복구를 위해 니모닉 코드를 입력해주세요.</Warning>
      <BtnContainer>
        <LengthBtn onClick={() => setLength(12)}>12개</LengthBtn>
        <LengthBtn onClick={() => setLength(24)}>24개</LengthBtn>
      </BtnContainer>
      <WordList>
      ...
      <Button onClick={checkMnemonic}>Next</Button>
    </Container>
  );
};
